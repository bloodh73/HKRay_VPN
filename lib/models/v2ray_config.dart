...
import 'dart:convert'; // برای استفاده از jsonDecode

class V2RayConfig {
  final String
  id; // این می تواند یک UUID یا یک شناسه منحصر به فرد برای سرور باشد
  ...
  factory V2RayConfig.fromV2RayURL(V2RayURL v2rayUrl) {
    ...
    try {
      final configMap = jsonDecode(v2rayUrl.getFullConfiguration());
    ...
    return V2RayConfig(
      ...
      remarks: v2rayUrl.remark,
      fullConfigJson: v2rayUrl.getFullConfiguration(),
    );
  }
